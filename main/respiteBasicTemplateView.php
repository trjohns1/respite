...
<?php
	// Print a hidden input field with the query string. Allows the page to send a query with POST requests.
	if (isset($view['formData']['queryString'])) {
		echo '<input type="hidden" name="queryString" value="' . $view['formData']['queryString'] . '">' . "\n";
	}
?>
...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <H1>Respite Basic Template</H1>

            <p>Use this template as a starting point for new pages</p>
            <ol>
               <li>Copy this file respiteBasicTemplate.php to a new location.</li>
               <li>Copy the associated view file respiteBasicTemplateView.php to a new location.</li>
               <li>Edit the new file to point to the new view.</li>
               <li>Copy elements from the full template and paste them into the new page as needed.</li>
            </ol>
            ...
            <div class="group">
               <div class="group_item">
                  ...
                  <div class="GroupRight">
                      <p class="note">Lorem ipsum dolor sit amet, <a href=#>mauris nonummy</a> quisque adipiscing, quis quod non interdum velit, est nonummy diam ipsum sem.</p>
                      <p class="tinyNote">Dictum in placerat adipiscing, leo enim mauris, arcu ante sit, ut sed nulla wisi.</p>
                   </div>
               </div>
