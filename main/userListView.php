...
//    ['users'] : An array of systerm users
//       ['username'] : The user's unique username
//          ['nameLast'] : The user's last name
//          ['nameFirst'] : The user's first name
//
// ** User Data
...
// $view['application']['users']['trjohns1']['nameLast'] = 'Johnson';
// $view['application']['users']['trjohns1']['nameFirst'] = 'Tyler';
// $view['application']['users']['gw']['nameLast'] = 'Washington';
// $view['application']['users']['gw']['nameFirst'] = 'George';
// $view['application']['users']['tj']['nameLast'] = 'Jefferson';
// $view['application']['users']['tj']['nameFirst'] = 'Thomas';
// $view['application']['users']['ph']['nameLast'] = 'Henry';
// $view['application']['users']['ph']['nameFirst'] = 'Patrick';
?>
...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <p class="group_label">Current System Users</p>
            <div class="group">
               ...
               <div class="group_item">
                  <div class="GroupLeft">
                     <label>User</label>
                     <p class="helper_text">click name to edit</p>
                  </div>
                  <div class="GroupRight">
                     <ol>
                        <?php
                           foreach($view['application']['users'] as $key=>$value) {
                              $targetURL = "../../respite/main/userEdit.php?username={$key}";
                              echo "<li><a href='{$targetURL}'>{$view['application']['users'][$key]['nameLast']}, {$view['application']['users'][$key]['nameFirst']}</a></li>";
                           }
                        ?>
                     </ol>
                   </div>
