   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <?php
               ...
               if (isset($view['application']['error'])) {
                  echo '<div class="alert">';
                  echo '<h1>Error</h1>';
                  echo '<p>' . $view['application']['error']['type'] . '</p>';
                  echo '</div>';
               }
            ?>
         <p>The system has encountered an error.</p>
         <p>If you think you have received this message improperly, please copy the contents of this message and paste them in an email to your system administrator.</p>

            <p class="group_label">Error Details</p>
            <div class="group">
               <div class="group_item">
                  ...
                  <div class="GroupRight">
                      <p class="note"><?php echo (isset($view['application']['error']['description']) ? $view['application']['error']['description'] : 'No description provided.') ?></p>
                   </div>
               </div>
               ...
               <div class="group_item">
                  <div class="GroupLeft">
                     <label>Referring Page</label>
                  </div>
                  <div class="GroupRight">
                      <p class="note"><?php echo (isset($view['application']['error']['page']) ? $view['application']['error']['page'] : 'No page detected.') ?></p>
                   </div>
               </div>
               <div class="group_item_close"></div>
               ...
               <div class="group_item">
                  ...
                  <div class="GroupRight">
                      <p class="note"><?php echo (isset($view['application']['error']['dump']) ? $view['application']['error']['dump'] : 'No data provided.') ?></p>
                   </div>
               </div>
               <div class="group_item_close"></div>
