<?php
   // This page simply displays a message indicating that the system is offline.
?>
...
?>
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
         ...
         <?php if(isset($_SESSION['offlineMessage'])) echo "<p>{$_SESSION['offlineMessage']}</p>" ?>
      </div>
   </div>
