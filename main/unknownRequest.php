...
?>
   <div id="titleBar">
      ...
      <p id="titleBarText">Unknown Request</p>
...
?>
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
         ...
         <p>You have submitted an HTTP POST request that is not recognized by this system. Please report this to the system administrator.</p>
			<p><?php if(isset($_SERVER['HTTP_REFERER'])) {echo 'Referring page: ' . $_SERVER['HTTP_REFERER'];} ?></p>
      </div>
   </div>
