...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <p>Use this screen to place the system into off-line mode.</p>
            <p>In off-line mode, only users with the respite_administrator role can log into the system. Once logged in their permissions follow their normal roles.</p>



            <p class="group_label">System Mode</p>
            <div class="group">
               <?php printControlRadio('offlineMode', & $view, 'System Mode', 'Set the system mode.', 'dirty'); ?>
               <hr />
               <?php printControlTextArea('message', & $view, 'Message', 'The message that users will see when they try to access the system if they do not have the respite_administrator role.', 'dirty'); ?>
            </div>
...
?>
   ...
   <div id="toolBarOuter">
      ...
      <div id="toolBar">
            ...
            <div class="buttonBar">
               <h1>Change System Mode</h1>
               <p>Select...</p>
               <input type="submit" name="cancel" value="cancel"/>
               <input type="submit" name="activate" value="Activate Mode" onclick="respiteClean()"/>
            </div>
