...
//    ['roles'] : an array of the roles assigned to the user
//
// ** User Data
...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
         ...
         <p class="group_label">Account Attributes</p>
         <div class="group">
            <div class="group_item">
               ...
               <div class="GroupRight">
                   <p class="note">The roles assigned to your account are listed below. These determine the privileges you have on the system.</p>
                   <p class="tinyNote">See your system administrator if you think these are incorrect.</p>
                  <ul>
                     <?php
                        foreach($view['user']['roles'] as $key=>$value){
                           echo '<li>' . $value . '</li>';
                        }
                     ?>
                  </ul>
         ...
         <p class="group_label">Update My Account Information</p>
         <div class="group">
   ...
   <div id="toolBarOuter">
      ...
      <div id="toolBar">
            ...
            <div class="buttonBar">
               ...
               <input type="submit" name="formActionCancel" value="Cancel"/>
               <input type="submit" name="formActionLogout" value="Logout"/>
            </div>
