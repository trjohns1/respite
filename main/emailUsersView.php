...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <p>Send a message to all system users.</p>
            <p>Use this feature to notify user of system maintenance windows and other administrative functions.</p>

            <p class="group_label">Compose Message</p>
            <div class="group">
               <?php printControlText('subject', & $view, 'Subject', 'Email subject line', 'dirty'); ?>
               <hr />
               <?php printControlTextArea('message', & $view, 'Message', 'No HTML allowed in message', 'dirty'); ?>
            </div>
   ...
   <div id="toolBarOuter">
      ...
      <div id="toolBar">
            ...
            <div class="buttonBar">
               ...
               <input type="submit" name="send" value="Send Message" onclick="respiteClean()"/>
            </div>
