...
$pageData = array(); // Holds miscellaneous information about the page, such as page and application name.
   ...
   $pageData['pageName'] = "Admin"; // A short, descriptive name for the page. Displayed in the Title Bar.
   $pageData['viewFilename'] = '../../respite/main/adminHomeView.php'; // The filename of the view that should be invoked.
