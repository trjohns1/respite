...
?>
   ...
   <div id="appPanelOuter">
      ...
      <div id="appPanel">
            ...
            <p class="group_label">User Information</p>
            <div class="group">
               <?php printControlHidden('username', & $view) ?>
               <div class="group_item">
                  <div class="GroupLeft">
                     <label>Username</label>
                  </div>
                  <div class="GroupRight">
                      <p class="note"><?php echo $view['formData']['username']?></p>
                      <?php if(isset($view['formData']['email'])) echo "<p class='tinyNote'><a href='mailto:{$view['formData']['email']}'>Click here to email user</a></p>" ?>
                   </div>
               </div>
               <div class="group_item_close"></div>
               <hr/>
               <?php printControlText('nameFirst', & $view, 'First Name', '', 'dirty'); ?>
               <hr />
               <?php printControlText('nameLast', & $view, 'Last Name', '', 'dirty'); ?>
               <hr />
               <?php printControlEmail('email', & $view, 'Email Address', '', 'dirty'); ?>
               <hr />
               <?php printControlTel('telephone', & $view, 'Telephone', '', 'dirty'); ?>
            </div>

            <p class="group_label">User Roles</p>
            <div class="group">
               <?php printControlLabelOnly('Role', "Select which roles the user should have. All users should have the 'respite_user' role for basic functionality. System administrators should have the 'respite_administrator' role."); ?>

               <?php
                  foreach($view['validCheckFields'] as $key=>$value) {
                     printControlCheckbox($key, & $view, $key, '', '', 'dirty');
                  }
               ?>
   ...
   <div id="toolBarOuter">
      ...
      <div id="toolBar">
            ...
            <div class="buttonBar">
               ...
               <input type="submit" name="save" value="save" onclick="respiteClean()"/>
            ...
            <div id="toolBarMenu">
               <ul>
			         <li class="toolBarMenuDivider">Manage Users</li>
                  <?php
                     // Include application menu
                     require_once "../../respite/includes_view/admin_menu.php";
                  ?>
               </ul>
            </div>
